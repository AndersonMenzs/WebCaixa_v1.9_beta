  ...
  <body>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
	 ...
	 <td width='74%' align="center">
	   <?php
	     echo "<font face='Arial', 'Courier', 'Verdana' size='6' color='aqua'>";
	 ...
	 <td width="13%" align="center">
	   <?php
		...
		break;
	     ...
	     echo "<font face='Arial', 'Courier', 'Verdana' size='4' color='lime'>";
	     echo "<i><b>$diaSem<font color='#FFFFFF'> $data <font color='gold'> $hora</b></i></font>";
	   ?>
	 </td>
      </tr>
