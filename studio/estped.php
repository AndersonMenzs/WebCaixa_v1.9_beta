...
//  End -->
  ...
  <body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
    <?php
     ...
     <b><center><u><i>Solicitação de Envio</i></u></center></b></font><br><?php
  ...
  if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok')
    {
     ...
     if ($NumDocE <> 0)
	   ...
	   <tr>
	      ...
	      <td width="50%" align="center">
    		 <font color='#FFFFFF' size='5'><b><i><blink><?php echo $NomeRec; ?></blink></i></b></font>
	      </td>
	   </tr>
	   ...
	   <tr>
	      <td width="50%" align="center">
  	      ...
  	      <td width="50%" align="center">
    		 <font color='#FFFFFF' size='5'><b><i><blink><?php
    		    if ($ModPgto == '')
    		      {
    		       echo 'Dinheiro';
    		      } else {
        			      echo $ModPgto; ?></blink></i></b></font><?php
        			     } ?>
   	      </td>
	   </tr>
	   ...
	   <input type="hidden" name="txtfpag" value="<?php echo $SlgPag; ?>">
	   ...
	   <center><font color='#FFFFFF' size='3'><span id="msg"></span></font></center>
	       ...
	       <br><br><br><br><font size='6'><b><center>Autenticação <font color='gold'><blink><u>Inexistente</u>
	       </blink><font color='#FFFFFF'>!!!<br>ou<br>
	       a Autenticação <font color='gold'><blink><u>Não Pertence</u></blink><font color='#FFFFFF'> ao Serviço!!!</center></b></font><br>
	       <center><a href='ped.php?c_s=<?php echo $lg_user; ?>'><img src='images/voltar.gif'></a></center><br><?php
	      }
    } else { ?>
