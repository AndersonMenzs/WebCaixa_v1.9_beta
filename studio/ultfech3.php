	       ...
	       for ($I=0; $I<=1; $I++)
   {
    // Imprimindo os Dados
       ...
       if ($regs > 0)
	 {
	  ...
	  while ($ln = mysqli_fetch_array($rs))
		...
		if ($cashi > 0)
		  {
		   $De = 'Dinheiro';       shell_exec("echo $traco > /dev/lp0");
	...
	shell_exec("echo '\n' > /dev/lp0");
     ...
     mysqli_free_result($rs);
      $SisRot = "S-7.5.3";
    ?>
<center><font color='yellow'><b><h1>Aguarde a Tela de Login e Senha.</h1></b></font></center>
<center><font color='yellow'><b><h2>Por Favor, Obrigado!</h2></b></font></center>
