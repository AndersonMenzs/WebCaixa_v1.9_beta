...
<body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
	...
	include "dblog.php";
	$sqlF = "select nome from pessoal where mat = '$user' ";
	...
	$sqlS = "select cargo from operador where mat = '$user' ";
	...
	if ($ch == 'ok-adm' or $ch == 'ok-enc' or $ch == 'ok') {
					...
					<center>Somente <font color='gold'>
							...
							<font color='#FFFFFF'> ou <blink><u>
								...
								<font color='#FFFFFF'><br><br>Podem <font color='gold'>
										<blink><u>Fazer o Emergencial</u></blink>
		...
		<?php
			...
			<table width="70%" border="5" cellpadding="10" cellspacing="0" align="center">
				<form name="confentr" method="post" action="geraemerg.php" OnSubmit="JavaScript:return checkdata()">
					<tr>
						<td width="40%" align="center">
							<font color='gold' size='5'><b><i>Nº do Lacre</i></b></font>
						</td>
						<td width="60%" align="center">
							<font color='#FFFFFF' size='5'><b><i><?php echo $Lacre; ?></i></b></font>
						</td>
					</tr>
