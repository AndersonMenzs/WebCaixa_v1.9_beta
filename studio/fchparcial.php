...
<script type="text/javascript" src="valparcrel.js" charset="utf-8">
</script>
  </head>
 ...
 if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok')
   { ?><br><br>
    <font size='4' color='gold'><b><u><i><center>FECHAMENTO DO CAIXA</center></i></u></b></font><br><br><?php

    // Recolhimento em Dinheiro ?>
       <form name="recolhe" method="post" action="fcxparc.php" OnSubmit="JavaScript:return checkdata()">
