...
<body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
	...
	<font color="gold" size="6"><br>
		<b>
			<center><u><i>FECHAMENTO DO CAIXA</i></u></center>
		</b>
	</font><br><br><br>
	<?php
			...
			if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok') { ?>
				<tr>
					<td>
						...
						<font size='4'><b><i> Fechamento Final </i></b></font>
					</td>
				</tr>
		</table>

		<br><br>
		<center><a href="index.php?c_s=<?php echo $lg_user ?>"><img src="./images/voltar.gif"></center><br>
	<?php
			}
		} else { ?>
	<br><br><br><br><br>
