...
document.onkeydown = F5;
  ...
  <body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
    ...
    <font color="gold" size="6"><br>
      <b><center><u><i>FECHAMENTO DO CAIXA</i></u></center></b></font><br><br><br><?php

  if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok')
    { ?>
     <table width="40%" border="0" cellpadding="0" cellspacing="10" align="center"><?php
     if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok')
       { ?>
	 <tr>
	   <td>
	      <a href="fechacaixa.php?c_s=<?php echo $lg_user; ?>"><img src="./images/star4.gif" width="25" border="0" align="top"></a><font size='4'><b><i> Fechamento Final </i></b></font>
	   </td>
	 </tr>

   <tr>
	   <td>
	      <a href="ultfech2.php?c_s=<?php echo $lg_user; ?>"><img src="./images/star4.gif" width="25" border="0" align="top"></a><font size='4'><b><i> Listar Fechamentos Finais Anteriores </i></b></font>
	   </td>
	 </tr>
