...
<script type="text/javascript" src="val_parcela.js" charset="utf-8">
  ...
  <body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
	...
	include "us_cad.php";
     ...
     <b><center><u><i>Contrato - Parcelas</i></u></center></b></font><br><?php

  if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok')
    { ?>
     <table width="70%" border="5" cellpadding="10" cellspacing="0" align="center">
     <form name="parcela" method="post" action="confcntparc.php" OnSubmit="JavaScript:return checkdata()">
	<tr>
	  <td width="65%" align="right">
	     <font color='gold' size='4'><b><i>Nº do Contrato</i></b></font>
	  </td>
	  <td width="35%">
	     <input type="text" name="txtdoc" size="6" maxlength="7" class="campos" onKeyUp = "validate(this)">
	  </td>
	</tr>
	...
	<tr>
	  ...
	  <select name="lsPr" class="campos"><?php
		...
		//$sqlpr = "select * from formapag order by codpag";
		$sqlpr = "SELECT * FROM formapag WHERE codpag NOT IN (40,50) ORDER BY codpag";
	...
	<tr>
	  <td width="65%" align="right">
	     <font color='gold' size='4'><b><i>Autenticação:</i></b></font>
	  </td>
	  <td width="35%">
	     <input type="radio" name="rdaut" class="campos" value="c"><font color='gold' size='4'><b><i>Carnê</i></b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	     <input type="radio" name="rdaut" class="campos" value="a"><font color='gold' size='4'><b><i>Avulso</i></b></font>
	     <input type="hidden" name="txtuser" value="<?php echo $lg_user; ?>">
	  </td>
	</tr>
     </table><br>
