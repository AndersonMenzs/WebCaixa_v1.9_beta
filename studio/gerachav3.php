...
<body background="../images/bg1.jpg" text="#FFFFFF">
	...
	// Gravando os Registros
				...
				$sqls = "select * from registro where numdoc = '$NDoc' ";
				...
				if ($NDoc_a == $NDoc_b) {
					?>
					<font color="gold" size="6">
						<br><b><center><i>O Número do Documento Existente.</i></center></b></font>
						<font color="gold" size="6">
							<b><center><i>Favor Inserir o Dado Corretamente.</i></center></b></font><br><br>

							<meta http-equiv="refresh" content="5;URL=./chaveiro.php?c_s=<?php echo $lg_user; ?>">
