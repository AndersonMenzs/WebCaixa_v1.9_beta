...
<script type="text/javascript" src="val_dev.js" charset="utf-8">
</script>
  </head>
  ...
  <body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
	...
	include "us_cad.php";
     ...
     <br><br><b><center><u><i>Devolução de Produtos</i></u></center></b></font><br><br><?php

  if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok')
    { ?>
     <table width="30%" border="5" cellpadding="6" cellspacing="0" align="center">
     <form name="Form" method="post" action="impdev.php" OnSubmit="JavaScript:return checkdata()">
	<tr>
	  <td align="center">
	     <font color='gold' size='5'><b><i>Data da Devolução</i></b></font>
	  </td>
	</tr>
