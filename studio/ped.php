...
<script type="text/javascript" src="val_ped.js" charset="utf-8">
  ...
  <body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
    ...
    <font color="gold" size="6"><br>
      <b><center><u><i>SOLICITAÇÕES</i></u></center></b></font><br><br><br><?php

  if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok')
    { ?>
     <table width="30%" border="5" cellpadding="10" cellspacing="0" align="center">
     <form name="frmest" method="post" action="estped.php" OnSubmit="JavaScript:return checkdata()">
	<tr>
