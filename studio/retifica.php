<html>
  ...
  <body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)"><?php
	...
	if ($ch == 'no')
     ...
     if ($ch == 'ok')
       { ?>
	<form name="retif" method="post" action="confretif.php" OnSubmit="JavaScript:return checkdata()">
	<br><font size='6' color='gold'><b><u><i><center>Retificação de Lançamento</center></i></u></b></font><br><br><?php
	...
	if ($DtOpen <> $Data)
	  { ?>
	   ...
	   <center><a href='aud.php?c_s=<?php echo $lg_user; ?>'><img src='images/voltar.gif'></a></center><br><?php
		  ...
		  <table width="85%" border="05" cellpadding="05" cellspacing="0" align="center">
		      <tr>
			 <td>
			 ...
			 <td>
			    ...
			    <input type="text" name="txtresp" size="8" maxlength="8" class="campos" OnKeyUp="validate(this)">
			 </td>
			 <td align='right'>
			    <font size="5"><b></i>Valor Autenticado: </i></b></font>
			 ...
			 <td>
			    ...
			    <select name="lsde" class="campos"><?php
			 ...
			 <td align='right'>
			    ...
			    <select name="lspara" class="campos"><?php
