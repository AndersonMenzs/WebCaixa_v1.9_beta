<html>
   ...
   <body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)"><?php
	 ...
	 if ($ch == 'ok')
	   { ?><br><br>
	    <font color='gold' size='6'><b><u><i><center>CADASTRAR FUNCIONÁRIOS</center></i></u></b></font> <br><br><br>
	    ...
	    <form name="oper" method="post" action="verifop.php" OnSubmit="JavaScript:return checkop()">
		  ...
		  <tr>
			...
			<select name="lsCargo" class="campos">
			   <option value="00" class="campos">SELECIONE</option><?php
			...
			// Obtendo a Relação
			   ...
			   // Criando a Instrução SQL de Consulta
			      $sqlC = "select * from cargos where ccargo = '04' or ccargo = '05' or ccargo = '08' order by ccargo";
			      ...
			      while ($lnC = mysqli_fetch_array($rsC))
				   {
				    ...
				    <option value="<?php echo "$CodCargo"."$Funcao"; ?>" class="campos"><?php echo strtoupper("$Funcao"); ?></option><?php
				   }
			...
			<table border="10" cellpadding="10" cellspacing="0" align="center">
			   <tr>
				 ...
				 <select name="lsCargo" class="campos">
				    ...
				    // Criando a Instrução SQL de Consulta
				       $sqlC = "select * from cargos where ccargo = '04' or ccargo = '05' order by ccargo";
	   ...
	   <table width="100%" border="0" cellpadding="0" cellspacing="0">
		 ...
		 <td width='70%' align='center'>
		    <font size='5'><b><i>Digite &quot;<font color='gold'><blink><u>00</u></blink><font color='#FFFFFF'>&quot; para Cadastrar <font color='lime'><blink><u>Free-Lancer</u></blink></i></b></font>
		 </td>
