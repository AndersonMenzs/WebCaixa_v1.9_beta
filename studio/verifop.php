...
<body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
	...
	<font color='gold' size='5'><b><u><i>
					<center>CADASTRAR O FUNCIONÁRIO</center>
				</i></u></b></font><br><br>
	<?php

	if (($ch == 'ok-enc' or $ch == 'ok-adm' or $ch == 'ok') and $MatOp <> '00000000') {
		// Abrindo a Conexão
		include "conexao.php";
	...
	?>
			...
			if ($regs > 0 and $regss > 0) { ?>
					<center>
						<font size='5'><b><i>Funcionário já Cadastrado na Função de <font color='lime'>
										<blink><?php echo "$cgoOpF"; ?></blink></i></b></font>
						</cemter><br><br>
					<?php
				} else if ($regs > 0 and $regss == 0) { ?>
						<center>
							<font size='5'><b><i>Funcionário <font color='lime'>
											<blink>Não Cadastrado</blink>
											<font color='#FFFFFF'>no Sistema!!!</i></b></font>
							</cemter><br><br>
						<?php
					}
				} else if (($ch == 'ok-enc' or $ch == 'ok-adm' or $ch == 'ok') and $MatOp == '00000000') {
					include "conexao.php";
					include "dblog.php";
					...
					// Exibindo Dados 
						...
						<form name="cadop" method="post" action="cadopfree.php" OnSubmit="JavaScript:return checkop()">
							<table align="center" border="10" cellpadding="10" cellspacing="0">
								<tr>
									<td colspan="2">
										<font size="4"><b><i>Matrícula: <font color='gold'><?php echo "$MatFreF"; ?><font color='lightgreen'>
															<blink>(Free-Lancer)</blink></i></b></font>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td align="center">
									<?php
									if ($regs > 0 and $regss > 0) { ?>
										<input type="submit" value="CADASTRAR ASSIM MESMO">
									<?php
									} else { ?>
						...
						if ($ch <> 'ok-enc' and $ch <> 'ok-adm' and $ch <> 'ok') { ?>
							<br><br><br><br>
							<font size='5'><b>
