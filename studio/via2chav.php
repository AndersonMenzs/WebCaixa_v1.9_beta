...
document.onkeydown = F5;
  ...
  <body background="../images/bg1.jpg" text="#FFFFFF">
    ...
    // Preparando Via Caixa ?>
       <form name="via2chav" method="post" action="via3chav.php">
	   ...
	   <br><br><br><br>
	   <font size='6'><b><center>Coloque a <font color='gold'><blink>Terceira Via</blink><font color='#FFFFFF'> na Autenticadora
	    e <br>
