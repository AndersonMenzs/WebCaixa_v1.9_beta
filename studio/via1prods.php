...
<body background="../images/bg1.jpg" text="#FFFFFF">
	...
	<font color="gold" size="6">
		<br><b>
			...
			$Aut1 = $Reg;
			$Aut2 = "$Reg$PC$horaaut$NDoc $dtAut$VrPagrF$SgRec$FmRec$MatRec";
			shell_exec("echo $Aut2 > /dev/lp0");

			// Preparando Ficha Cliente 
			?>
	<form name="via1prop" method="post" action="via2prods.php">
		...
		<input type="hidden" name="txtpag" value="<?php echo $VrPag; ?>">
