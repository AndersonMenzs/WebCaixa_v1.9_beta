...
document.onkeydown = F5;
  ...
  <body background="../images/bg1.jpg"><?php
	...
	include "dbselect.php";
       ...
       $rs  = mysqli_query($conec, $sql) or die ("File reimpfech Error #1. Contate seu Administrador.");
	  ...
	  // Obtendo o Total Arrecadado
	     $sqlTT = "select vlrec from registro where datarec = '$DataHoje' and tiporec <> '8' " ;
...
for ($I=0; $I<=1; $I++)
   {
    ...
    // Gerando a Retificação
       ...
       $rs  = mysqli_query($conec, $sql) or die ("File reimpfech Error #2. Contate seu Administrador.");
...
//       include "detvendas.php";
	...
	// Obtendo a Relação de Operadores Cadastrados
	   ...
	   $rsH2  = mysqli_query($conec, $sqlH2) or die ("File reimpfech Error #3. Contate seu Administrador.");
	   $regH2 = mysqli_num_rows($rsH2);
	...
	// Obtendo a Relação de Recuperação de Senhas
	   ...
	   $rsR   = mysqli_query($conec, $sqlR) or die ("File reimpfech Error #5. Contate seu Administrador.");
