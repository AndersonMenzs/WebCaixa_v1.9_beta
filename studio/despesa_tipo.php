			...
			<form name="pgtos" method="post" action="confdesp.php" OnSubmit="JavaScript:return checkdata()">
				...
				<tr>
					...
					<td width="18%" align="center">
						...
						<input type="hidden" name="mat_colab" value="<?php echo $mat_colab; ?>">
					...
					<td width="32%" align="center">
						<select name="lsref" class="campos">
							<option value="ad_sal">Adiantamento Salarial</option>
							<option value="sal">Salário</option>
							<option value="fer">Ferias</option>
							<option value="prem">Premiação</option>
							<option value="serv_prest">Serviços Prestados</option>
						</select>
				</tr>
		</table><br>
