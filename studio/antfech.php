...
<script type="text/javascript" src="val_data.js" charset="utf-8">
  ...
  <body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
    ...
    <font color="gold" size="6"><br>
      <b><center><u><i>FECHAMENTOS ANTERIORES</i></u></center></b></font><br><br><br><?php

  if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok')
    { ?>
     <form name="frmcnt" method="post" action="ultfech2.php" OnSubmit="JavaScript:return checkdados()">
     <table border="10" cellpadding="10" cellspacing="0" align="center">
	<tr>
	  <td>
	      <font size='4'><b><i>Fechamento do Dia </i></b></font>
	  </td>
	  <td>
