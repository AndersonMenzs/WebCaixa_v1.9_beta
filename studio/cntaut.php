  ...
  <body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
	...
	<tr>
	   ...
	   <td align="center">
	      ...
	      <b><u><i>Autenticações do Dia - <font color='#FFFFFF'><?php echo $DataAut; ?></i></u></center></b></font>
	   </td>
	   <td>
	      <a href="cnt.php?c_s=<?php echo $lg_user ?>"><img src="./images/voltar.gif"></a>
	   </td>
		 ...
		 if ($TipoRec <> 'E')
		   { ?>
		    <tr>
			  ...
			  if ($Estorno <> "")
			    { ?>
			     <font color='gold'><blink>Sim</blink><?php
			    } else { ?>
				    Não<?php
				   } ?></i></b></font>
		       </td>
	      ...
	      <br><br><font size='6' color='gold'><b><center><blink><u>Nenhum</u></blink><font color='#FFFFFF'> Registro Encontrado Nesta Data!!!</center></b></font><?php
	     } ?>
    <br><br><center><a href="cnt.php?c_s=<?php echo $lg_user ?>"><img src="./images/voltar.gif"></a></center><br><?php
   } else { ?>
	   ...
	   <center><a href='cnt.php?c_s=<?php echo $lg_user; ?>'><img src='images/voltar.gif'></a></center><br><br><?php
	  }
