...
<script type="text/javascript" src="val_pgto.js" charset="utf-8">
  ...
  <body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
    <?php
	 ...
	 $QtdeParc  = trim($_POST['txtnparc']);
	 $PIni      = trim($_POST['txtparc']);
	 $PUlt      = $PIni + $QtdeParc - 1;
 ...
 if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok')
   { ?>
    <table width="90%" border="5" cellpadding="5" cellspacing="0" align="center">
      <form name="confentr" method="post" action="gerapropparc.php" OnSUbmit="JavaScript:return checkdata()">
	<tr>
	...
	<tr>
	  <td width="30%" align="center">
	     <font color='gold' size='5'><b><i>Nº da Prestação</i></b></font>
	  </td>
	  <td width="70%" align="center">
	     <font color='#FFFFFF' size='5'><b><i><?php
		if ($PIni == $PUlt)
		  {
		   echo $PIni;
		  } else {
	...
	<tr>
	  ...
	  <td width="70%" align="center">
	     <font color='#FFFFFF' size='5'><b><i><?php echo "R$ ".$ParcF; ?></i></b></font>
	  </td>
	</tr><?php
       } ?>
	...
	<input type="hidden" name="txtparc" value="<?php echo $QtdeParc; ?>">
	<input type="hidden" name="txtvalor" value="<?php echo $VrEntr; ?>">
	<input type="hidden" name="txtvrparc" value="<?php echo $Parc; ?>">
	<input type="hidden" name="txtparci" value="<?php echo $PIni; ?>">
	<input type="hidden" name="txtparcu" value="<?php echo $PUlt; ?>">
	<input type="hidden" name="txtdoc" value="<?php echo $NDoc; ?>">
	<input type="hidden" name="txtmodpag" value="<?php echo $FPag; ?>">
	<p><center><input id="ghost_click" type="submit" name="btenvia" value="Continuar">
