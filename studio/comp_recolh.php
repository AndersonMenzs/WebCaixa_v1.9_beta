...
$tipoDocumento  = "Recolhimento de Valores";

$lacre      = trim($_GET['Envelope']);
...
$assunto        = "Comprovante de Recolhimento de Caixa";
...
$autenticacao    = trim($_GET['SdFinal']);
...
<body onload="window.print()">
    <div class="container">
        ...
        <div class="texto">
            Declaramos para os devidos fins que foi realizado o recolhimento
            no valor de <strong><i>R$ <?= htmlspecialchars($valor) . " (" . $valorExtenso . ")" ?></i></strong>,
            vinculado ao lacre <strong><i><?= htmlspecialchars($lacre) ?></i></strong>,
            na unidade <strong><i><?= htmlspecialchars($origem) ?></i></strong>.

            <br><br>

            O recolhimento foi efetuado por
