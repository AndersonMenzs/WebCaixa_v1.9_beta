...
<body background="../images/bg1.jpg" text="#FFFFFF" onLoad="putFocus(0,0)">
				...
				<tr>
					...
					<td rowspan="3" align="center">
						...
						<font color='#FFFFFF' size='4'><b><i>
									...
									<span id="Psep" style="<?php echo ($PIni == $PUlt) ? 'display:none;' : ''; ?>"> a </span>
									<span id="PUlt" style="<?php echo ($PIni == $PUlt) ? 'display:none;' : ''; ?>"><?php echo $PUlt; ?></span>
								</i></b></font>
					</td>
					<td rowspan="3" align="center">
	...
	<script>
		...
		function atualizaParcelas() {
			...
			if (PUltEl && PsepEl) {
				if (pIni === pUlt) {
					PUltEl.textContent = pUlt; // mantém valor no hidden também
