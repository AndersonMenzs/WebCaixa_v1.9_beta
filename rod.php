...
<table width="100%" border="0" cellspacing="0">
  <tr>
	...
	<!-- <font face="sans-serif, Arial, Helvetica, Tahoma" size="4"><b><i><?php //echo "Usuário: <font color='lime'>$Apld"; ?></font></i></b></font> -->
     ...
     <td width="52%">
       <div align="center">
	<img src='./images/estrela1.gif' width='20'>
	<img src='./images/estrela1.gif' width='20'>
	<img src='./images/estrela1.gif' width='20'>
	<font face="sans-serif, Arial, Helvetica, Tahoma" size="5"><i>"O maior e melhor do Brasil".</i></font>
	<img src='./images/estrela1.gif' width='20'>
	<img src='./images/estrela1.gif' width='20'>
	<img src='./images/estrela1.gif' width='20'>
       </div>
     ...
     <td width="23%" rowspan='2' align="right">
       <font size="4" color="#FFFFFF"><b><i><?php echo $SisRot; ?></i></b>
     </td>
  </tr>
