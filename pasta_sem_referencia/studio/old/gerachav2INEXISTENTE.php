...
<body background="../images/bg1.jpg" text="#FFFFFF">
	...
	// Gravando os Registros
				...
				$sqla = "select numdoc from registro";
				$rsa = mysqli_query($conec, $sqla) or die ("Erro na consulta");
				$lna = mysqli_fetch_array($rsa);
				$NumDocA = $lna['numdoc'];

				$DocNum = mysqli_real_escape_string($NumDocA);

				$sqlb = "select * from registro where numdoc = '$DocNum' ";
				$rsb = mysqli_query($conec, $sqlb) or die ("Erro na consulta NumDoc");
