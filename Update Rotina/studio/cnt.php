...
<script type="text/javascript" src="val_data.js" charset="utf-8">
  ...
  if ($ch == 'ok-enc' or $ch == 'ok-cai' or $ch == 'ok')
    { ?>
     <form name="frmcnt" method="post" action="cntaut.php" OnSubmit="JavaScript:return checkdados()">
    ...
    <br><br><center><a href="consulta.php?c_s=<?php echo $lg_user ?>"><img src="./images/voltar.gif"></center><br><?php
    } else { ?>
