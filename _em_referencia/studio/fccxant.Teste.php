<html>
     ...
     <body background="../images/bg1.jpg" link='lime' vlink='#FFFFFF' alink='lime' text="#FFFFFF"><?php
...
//////
	   ...
	   <table width="100%" border="0" cellpadding="0" cellspacing="0">
		 ...
		 <td  width="34%">
		  ...
		  <td width="33%">
			...
			<tr>
			   <td>
			      <font color="gold"><b><i>Total em Cartão Débito: . . . . </b></i></font>
			...
			<tr>
		     ...
		     <center><font color="gold"><b><i>&nbsp;Diferença de Caixa: </b></i></font><b><i>R$ <?php echo $DifCx;
		     if ($Diferenca <> 0)
		       { ?>
		 ...
		 <td width="33%">
		    <table  border="05" cellpadding="02" cellspacing="0" align="right">
		       <tr>
			  <td align='center'>
			     <font color="aqua"><b><i>TOTALIZAÇÕES: &nbsp;&nbsp;<font color='#FFFFFF'><blink><?php echo "$TotAut Autenticações Válidas"; ?></blink></b></i></font>
			  </td>
		       </tr>
			  ...
			  <td><?php
				...
				<b><i><?php echo "R$ $IncSobraF"; ?></i></b><?php
			       } else { ?>
				       &nbsp;<?php
				      } ?>
			  </td>
	 ...
	 <p><center><a href='http://localhost/caixa'><img src='./images/sair2.gif' border='0'></a>&nbsp;&nbsp;&nbsp;
	 <a href="reimpfech.php?c_s=<?php echo $lg_user; ?>"><img src="./images/reimp.gif" border="0"></a></p><?php
   ...
   while ($lnCad = mysqli_fetch_array($rsCad))
	{
	 $MatCad = $lnCad['mat'];
		 ...
		 if ($regRec > 0)
	      ...
	      shell_exec("echo ' CashT'-'$cashTot' > /dev/lp0");
	      shell_exec("echo ' Deb  '-'$cDebFinal' > /dev/lp0");
	      shell_exec("echo ' CredV'-'$credTotV' > /dev/lp0");
	      shell_exec("echo ' CrdPL'-'$credTotPLoja' > /dev/lp0");
	      shell_exec("echo ' CrdPA'-'$credTotPAdm' > /dev/lp0");
	      shell_exec("echo ' ChqTV'-'$cheqTotV' > /dev/lp0");
	      shell_exec("echo ' ChqTP'-'$cheqTotPre' > /dev/lp0");
	      shell_exec("echo ' DepCl'-'$DepClientes' > /dev/lp0");
	      shell_exec("echo '\n' > /dev/lp0");
